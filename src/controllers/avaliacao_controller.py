...
from controllers.email_service import (email_configurado, email_destino, enviar_email,
...
def _resultado_pdf_bytes(avaliacao):
    ...
    html_str = render_template('avaliacoes/resultado_pdf.html',
                               avaliacao=avaliacao,
